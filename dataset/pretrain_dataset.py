...
class PretrainDataset(Dataset):
    ...
    def __init__(
        self,
        image_annotation_path='/root/autodl-tmp/Crab/data/video-llava/train_json/llava_image_.json',
        video_annotation_path='/root/autodl-tmp/Crab/data/video-llava/train_json/valid_valley_.json',
        video_llava_data_root='/root/autodl-tmp/Crab/data/video-llava',
        image_caption_task=False,
        video_caption_task=False,
        image_size = 224,
        video_frame_nums = 8,
        # wavcaps_data_root='/DATA/DATANAS2/ligy/WavCaps',
        audiocaps_data_root='/root/autodl-tmp/Crab/data/AudioCaps',
        audio_caption_task=False,
        grounded_vqa_data_root='/root/autodl-tmp/Crab/data/GroundedVQA',
        segmentation_task=False,
        image_scale_nums = 2,
        token_nums_per_scale = 3,
        lvis_data_root='/root/autodl-tmp/Crab/data/LVIS',
